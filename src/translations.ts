...
export const TRANSLATIONS = {
  en: {
    ...
    cursorHighlightTitle: "Cursor Highlight",
    cursorHighlightDesc: "Highlight cursor for presentations",
    // Cleaner Card
    ...
    toastCursorHighlightOn: "Cursor Highlight Enabled",
    toastCursorHighlightOff: "Cursor Highlight Disabled",
    toastCursorHighlightFail: "Could not toggle cursor highlight",
  ...
  tr: {
    ...
    cursorHighlightTitle: "İmleç Vurgulama",
    cursorHighlightDesc: "Sunumlar için imleci vurgulayın",
    // Cleaner Card
    ...
    toastCursorHighlightOn: "İmleç Vurgulama Etkinleştirildi",
    toastCursorHighlightOff: "İmleç Vurgulama Kapatıldı",
    toastCursorHighlightFail: "İmleç vurgulama değiştirilemedi",
  ...
  az: {
    ...
    cursorHighlightTitle: "Kursor Vurğulaması",
    cursorHighlightDesc: "Təqdimatlar üçün kursoru vurğulayın",
    // Cleaner Card
    ...
    toastCursorHighlightOn: "Kursor Vurğulaması Aktiv Edildi",
    toastCursorHighlightOff: "Kursor Vurğulaması Söndürüldü",
    toastCursorHighlightFail: "Kursor vurğulaması dəyişdirilə bilmədi",
  ...
  es: {
    ...
    cursorHighlightTitle: "Resaltado del Cursor",
    cursorHighlightDesc: "Resalta el cursor para presentaciones",
    // Cleaner Card
    ...
    toastCursorHighlightOn: "Resaltado del Cursor Activado",
    toastCursorHighlightOff: "Resaltado del Cursor Desactivado",
    toastCursorHighlightFail: "No se pudo cambiar el resaltado del cursor",
  ...
  sq: {
    ...
    cursorHighlightTitle: "Theksimi i Kursorit",
    cursorHighlightDesc: "Theksoni kursorin për prezantime",
    // Cleaner Card
    ...
    toastCursorHighlightOn: "Theksimi i Kursorit u Aktivizua",
    toastCursorHighlightOff: "Theksimi i Kursorit u Çaktivizua",
    toastCursorHighlightFail: "Theksimi i kursorit nuk mund të ndryshohej",
